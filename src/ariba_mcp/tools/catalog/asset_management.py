...
Owner: Nitish
Docs: https://help.sap.com/docs/ariba-apis/asset-management-api/endpoints-included-in-asset-management-api

Endpoints covered:
  GET  /requisitions               – list requisitions with asset line items
  GET  /requisitions/count         – total count of asset requisitions
  POST /requisitions/batch/assets  – assign / update asset values on line items
"""
...
ASSET_MANAGEMENT_API = "asset-management/v1/prod"
...
def register(mcp: FastMCP, client: AribaClient) -> None:
    ...
    async def asset_list_requisitions(
        ...
        """
        Args:
            time_created: Filter by creation date (ISO-8601), e.g. '2024-01-01T00:00:00Z'.
            time_updated: Filter by last-updated date (ISO-8601), e.g. '2024-06-01T00:00:00Z'.
            top:          Max number of records to return (default 50).
        ...
        try:
            ...
            result = await client.fetch_resource(ASSET_MANAGEMENT_API, "requisitions", params)
    ...
    async def asset_count_requisitions(
        ...
        try:
            ...
            result = await client.fetch_resource(ASSET_MANAGEMENT_API, "requisitions/count", params)
            return json.dumps(result, default=str)
        except Exception as e:
            return handle_ariba_error(e)
    ...
    async def asset_update_line_items(
        ...
        """
        Args:
            requisition_id:        Unique ID of the requisition (e.g. 'PR-123456').
            number_in_collection:  Line item number inside the requisition.
            asset_number:          Asset number to assign (e.g. 'AST-0001').
        ...
        try:
            ...
            result = await client.post_resource(
                ASSET_MANAGEMENT_API, "requisitions/batch/assets", payload
            )
            return json.dumps(result, default=str)
        except Exception as e:
            return handle_ariba_error(e)